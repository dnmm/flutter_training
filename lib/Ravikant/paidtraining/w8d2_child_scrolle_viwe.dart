...
class W8D2SingleChildScrollView extends StatelessWidget {
  const W8D2SingleChildScrollView({super.key});
              ...
              child: Column(
                ...
                children: <Widget>[
                  Container(
                    ...
                    child:
                        const Text('Container 1'), // Text inside the container
                  ),
                  Container(
                    ...
                    alignment: Alignment.center,
                    child:
                        const Text('Container 2'), // Text inside the container
                  ),
