...
class Gridparts2 extends StatelessWidget {
  const Gridparts2({Key? key}) : super(key: key);
              ...
              child: ClipRRect(
                ...
                child: Stack(
                  children: <Widget>[
                    ...
                    Container(
                      margin: EdgeInsets.only(top: 170, left: 80),
                      height: 20,
                      width: 90,
                      child: Stack(
                        children: <Widget>[
                    ...
                    Container(
                      margin: EdgeInsets.only(top: 165, left: 10),
                      child: Text(
                        'rs. 349',
                        style: TextStyle(
