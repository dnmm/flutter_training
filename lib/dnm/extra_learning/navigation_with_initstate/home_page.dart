...
class MyNavigationInitState extends StatefulWidget {
  const MyNavigationInitState({Key? key}) : super(key: key);

  @override
  _NavigationState createState() => _NavigationState();
}

class _NavigationState extends State<MyNavigationInitState> {
  @override
